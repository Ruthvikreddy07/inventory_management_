...
class sut(object):
    ...
    def act1(self):
        ...
        '''
        self.__test.append(('''// Test adding a product ''',self.guard1,self.act1))
        self.__raised = None
        self.__refRaised = None
        if self.__verboseActions:
            __bV = {}
            print('ACTION:',self.prettyName('''// Test adding a product '''))
        if self.__collectCov: self.__cov.start()
        try: test_before_each(self)
        except: pass
        try:
    ...
    def guard2(self):
        '''
        add_product : (string, string, float, int, int)
        '''
        return (add_product : (string, string, float, int, int))
    
    def act3(self):
        '''
        // Test removing a product
        '''
        self.__test.append(('''// Test removing a product ''',self.guard3,self.act3))
        self.__raised = None
        self.__refRaised = None
        if self.__verboseActions:
            __bV = {}
            print('ACTION:',self.prettyName('''// Test removing a product '''))
        if self.__collectCov: self.__cov.start()
        try: test_before_each(self)
        except: pass
        try:
    ...
    def guard4(self):
        ...
        '''
        return (remove_product : (string))
    
    def act5(self):
        '''
        // Test updating product details
        '''
        self.__test.append(('''// Test updating product details ''',self.guard5,self.act5))
        self.__raised = None
        self.__refRaised = None
        if self.__verboseActions:
            __bV = {}
            print('ACTION:',self.prettyName('''// Test updating product details '''))
        if self.__collectCov: self.__cov.start()
        try: test_before_each(self)
        except: pass
        try:
    ...
    def guard6(self):
        '''
        update_product_details : (string, string?, float?, int?, int?)
        '''
        return (update_product_details : (string, string?, float?, int?, int?))
    
    def act7(self):
        '''
        // Test displaying current inventory
        '''
        self.__test.append(('''// Test displaying current inventory ''',self.guard7,self.act7))
        self.__raised = None
        self.__refRaised = None
        if self.__verboseActions:
            __bV = {}
            print('ACTION:',self.prettyName('''// Test displaying current inventory '''))
        if self.__collectCov: self.__cov.start()
        try: test_before_each(self)
        except: pass
        try:
    ...
    def guard8(self):
        ...
        '''
        return (display_current_inventory :)
    
    def act9(self):
        '''
        // Test tracking stock levels
        '''
        self.__test.append(('''// Test tracking stock levels ''',self.guard9,self.act9))
        self.__raised = None
        self.__refRaised = None
        if self.__verboseActions:
            __bV = {}
            print('ACTION:',self.prettyName('''// Test tracking stock levels '''))
        if self.__collectCov: self.__cov.start()
        try: test_before_each(self)
        except: pass
        try:
    ...
    def guard10(self):
        ...
        track_stock_levels :
        '''
        return (track_stock_levels :)
    
    def act11(self):
        '''
        // Test generating purchase orders
        '''
        self.__test.append(('''// Test generating purchase orders ''',self.guard11,self.act11))
        self.__raised = None
        self.__refRaised = None
        if self.__verboseActions:
            __bV = {}
            print('ACTION:',self.prettyName('''// Test generating purchase orders '''))
        if self.__collectCov: self.__cov.start()
        try: test_before_each(self)
        except: pass
        try:
    ...
    def act13(self):
        ...
        '''
        self.__test.append(('''// Test calculating total inventory value ''',self.guard13,self.act13))
        self.__raised = None
        self.__refRaised = None
        if self.__verboseActions:
            __bV = {}
            print('ACTION:',self.prettyName('''// Test calculating total inventory value '''))
        if self.__collectCov: self.__cov.start()
        try: test_before_each(self)
        except: pass
        try:
    ...
    def guard14(self):
        ...
        '''
        return (calculate_total_inventory_value :)
    
    def act15(self):
        '''
        // Test setting low stock alert threshold
        '''
        self.__test.append(('''// Test setting low stock alert threshold ''',self.guard15,self.act15))
        self.__raised = None
        self.__refRaised = None
        if self.__verboseActions:
            __bV = {}
            print('ACTION:',self.prettyName('''// Test setting low stock alert threshold '''))
        if self.__collectCov: self.__cov.start()
        try: test_before_each(self)
        except: pass
        try:
    ...
    def guard16(self):
        '''
        set_low_stock_alert : (string, int)
        '''
        return (set_low_stock_alert : (string, int))
    
    def act17(self):
        '''
        // Test recording product sale
        '''
        self.__test.append(('''// Test recording product sale ''',self.guard17,self.act17))
        self.__raised = None
        self.__refRaised = None
        if self.__verboseActions:
            __bV = {}
            print('ACTION:',self.prettyName('''// Test recording product sale '''))
        if self.__collectCov: self.__cov.start()
        try: test_before_each(self)
        except: pass
        try:
    ...
    def guard18(self):
        '''
        record_product_sale : (string, int)
        '''
        return (record_product_sale : (string, int))
    
    def act19(self):
        '''
        // Test exporting inventory data to a file
        '''
        self.__test.append(('''// Test exporting inventory data to a file ''',self.guard19,self.act19))
        self.__raised = None
        self.__refRaised = None
        if self.__verboseActions:
            __bV = {}
            print('ACTION:',self.prettyName('''// Test exporting inventory data to a file '''))
        if self.__collectCov: self.__cov.start()
        try: test_before_each(self)
        except: pass
        try:
    ...
    def guard20(self):
        '''
        export_inventory_data : (string)
        '''
        return (export_inventory_data : (string))
    ...
    # END INITIALIZATION CODE
        self.__SUTName = """InventoryManagementSystem"""
        self.__actions = []
        self.__names = {}
        ...
        self.__actionClasses.append('''// Test adding a product ''')
        self.__actionClasses.append('''add_product : (string, string, float, int, int) -> none ''')
        self.__actionClasses.append('''// Test removing a product ''')
        self.__actionClasses.append('''remove_product : (string) -> none ''')
        self.__actionClasses.append('''// Test updating product details ''')
        self.__actionClasses.append('''update_product_details : (string, string?, float?, int?, int?) -> none ''')
        self.__actionClasses.append('''// Test displaying current inventory ''')
        self.__actionClasses.append('''display_current_inventory : -> none ''')
        self.__actionClasses.append('''// Test tracking stock levels ''')
        self.__actionClasses.append('''track_stock_levels : -> none ''')
        self.__actionClasses.append('''// Test generating purchase orders ''')
        self.__actionClasses.append('''generate_purchase_orders : -> none ''')
        self.__actionClasses.append('''// Test calculating total inventory value ''')
        self.__actionClasses.append('''calculate_total_inventory_value : -> none ''')
        self.__actionClasses.append('''// Test setting low stock alert threshold ''')
        self.__actionClasses.append('''set_low_stock_alert : (string, int) -> none ''')
        self.__actionClasses.append('''// Test recording product sale ''')
        self.__actionClasses.append('''record_product_sale : (string, int) -> none ''')
        self.__actionClasses.append('''// Test exporting inventory data to a file ''')
        self.__actionClasses.append('''export_inventory_data : (string) -> none ''')
        self.__dependencies = {}
        self.__dependencies['''include "main.py" '''] = []
        self.__dependencies['''// Test adding a product '''] = []
        self.__dependencies['''add_product : (string, string, float, int, int) -> none '''] = []
        self.__dependencies['''// Test removing a product '''] = []
        self.__dependencies['''remove_product : (string) -> none '''] = []
        self.__dependencies['''// Test updating product details '''] = []
        self.__dependencies['''update_product_details : (string, string?, float?, int?, int?) -> none '''] = []
        self.__dependencies['''// Test displaying current inventory '''] = []
        self.__dependencies['''display_current_inventory : -> none '''] = []
        self.__dependencies['''// Test tracking stock levels '''] = []
        self.__dependencies['''track_stock_levels : -> none '''] = []
        self.__dependencies['''// Test generating purchase orders '''] = []
        self.__dependencies['''generate_purchase_orders : -> none '''] = []
        self.__dependencies['''// Test calculating total inventory value '''] = []
        self.__dependencies['''calculate_total_inventory_value : -> none '''] = []
        self.__dependencies['''// Test setting low stock alert threshold '''] = []
        self.__dependencies['''set_low_stock_alert : (string, int) -> none '''] = []
        self.__dependencies['''// Test recording product sale '''] = []
        self.__dependencies['''record_product_sale : (string, int) -> none '''] = []
        self.__dependencies['''// Test exporting inventory data to a file '''] = []
        self.__dependencies['''export_inventory_data : (string) -> none '''] = []
        self.__orderings = {}
        self.__okExcepts = {}
        self.__preCode = {}
        self.__refCode = {}
        ...
        self.__actions.append(('''// Test adding a product ''',self.guard1,self.act1))
        self.__names['''// Test adding a product '''] = ('''// Test adding a product ''',self.guard1,self.act1)
        self.__actionClass['''// Test adding a product '''] = '''// Test adding a product '''
        self.__orderings['''// Test adding a product '''] = 2
        self.__okExcepts['''// Test adding a product '''] = ''''''
        
        self.__actions.append(('''none ''',self.guard2,self.act2))
        self.__names['''none '''] = ('''none ''',self.guard2,self.act2)
        self.__actionClass['''none '''] = '''add_product : (string, string, float, int, int) -> none '''
        self.__orderings['''none '''] = 3
        self.__okExcepts['''none '''] = ''''''
        
        self.__actions.append(('''// Test removing a product ''',self.guard3,self.act3))
        self.__names['''// Test removing a product '''] = ('''// Test removing a product ''',self.guard3,self.act3)
        self.__actionClass['''// Test removing a product '''] = '''// Test removing a product '''
        self.__orderings['''// Test removing a product '''] = 4
        self.__okExcepts['''// Test removing a product '''] = ''''''
        
        self.__actions.append(('''none  ''',self.guard4,self.act4))
        self.__names['''none  '''] = ('''none  ''',self.guard4,self.act4)
        self.__actionClass['''none  '''] = '''remove_product : (string) -> none '''
        self.__orderings['''none  '''] = 5
        self.__okExcepts['''none  '''] = ''''''
        self.__refCode['''none  '''] = []
        self.__refCode['''none  '''].append('''none ''')
        
        self.__actions.append(('''// Test updating product details ''',self.guard5,self.act5))
        self.__names['''// Test updating product details '''] = ('''// Test updating product details ''',self.guard5,self.act5)
        self.__actionClass['''// Test updating product details '''] = '''// Test updating product details '''
        self.__orderings['''// Test updating product details '''] = 6
        self.__okExcepts['''// Test updating product details '''] = ''''''
        
        self.__actions.append(('''none   ''',self.guard6,self.act6))
        self.__names['''none   '''] = ('''none   ''',self.guard6,self.act6)
        self.__actionClass['''none   '''] = '''update_product_details : (string, string?, float?, int?, int?) -> none '''
        self.__orderings['''none   '''] = 7
        self.__okExcepts['''none   '''] = ''''''
        self.__refCode['''none   '''] = []
        self.__refCode['''none   '''].append('''none ''')
        
        self.__actions.append(('''// Test displaying current inventory ''',self.guard7,self.act7))
        self.__names['''// Test displaying current inventory '''] = ('''// Test displaying current inventory ''',self.guard7,self.act7)
        self.__actionClass['''// Test displaying current inventory '''] = '''// Test displaying current inventory '''
        self.__orderings['''// Test displaying current inventory '''] = 8
        self.__okExcepts['''// Test displaying current inventory '''] = ''''''
        
        self.__actions.append(('''none    ''',self.guard8,self.act8))
        self.__names['''none    '''] = ('''none    ''',self.guard8,self.act8)
        self.__actionClass['''none    '''] = '''display_current_inventory : -> none '''
        self.__orderings['''none    '''] = 9
        self.__okExcepts['''none    '''] = ''''''
        self.__refCode['''none    '''] = []
        self.__refCode['''none    '''].append('''none ''')
        
        self.__actions.append(('''// Test tracking stock levels ''',self.guard9,self.act9))
        self.__names['''// Test tracking stock levels '''] = ('''// Test tracking stock levels ''',self.guard9,self.act9)
        self.__actionClass['''// Test tracking stock levels '''] = '''// Test tracking stock levels '''
        self.__orderings['''// Test tracking stock levels '''] = 10
        self.__okExcepts['''// Test tracking stock levels '''] = ''''''
        
        self.__actions.append(('''none     ''',self.guard10,self.act10))
        self.__names['''none     '''] = ('''none     ''',self.guard10,self.act10)
        self.__actionClass['''none     '''] = '''track_stock_levels : -> none '''
        self.__orderings['''none     '''] = 11
        self.__okExcepts['''none     '''] = ''''''
        self.__refCode['''none     '''] = []
        self.__refCode['''none     '''].append('''none ''')
        
        self.__actions.append(('''// Test generating purchase orders ''',self.guard11,self.act11))
        self.__names['''// Test generating purchase orders '''] = ('''// Test generating purchase orders ''',self.guard11,self.act11)
        self.__actionClass['''// Test generating purchase orders '''] = '''// Test generating purchase orders '''
        self.__orderings['''// Test generating purchase orders '''] = 12
        self.__okExcepts['''// Test generating purchase orders '''] = ''''''
        
        self.__actions.append(('''none      ''',self.guard12,self.act12))
        self.__names['''none      '''] = ('''none      ''',self.guard12,self.act12)
        self.__actionClass['''none      '''] = '''generate_purchase_orders : -> none '''
        self.__orderings['''none      '''] = 13
        self.__okExcepts['''none      '''] = ''''''
        self.__refCode['''none      '''] = []
        self.__refCode['''none      '''].append('''none ''')
        
        self.__actions.append(('''// Test calculating total inventory value ''',self.guard13,self.act13))
        self.__names['''// Test calculating total inventory value '''] = ('''// Test calculating total inventory value ''',self.guard13,self.act13)
        self.__actionClass['''// Test calculating total inventory value '''] = '''// Test calculating total inventory value '''
        self.__orderings['''// Test calculating total inventory value '''] = 14
        self.__okExcepts['''// Test calculating total inventory value '''] = ''''''
        
        self.__actions.append(('''none       ''',self.guard14,self.act14))
        self.__names['''none       '''] = ('''none       ''',self.guard14,self.act14)
        self.__actionClass['''none       '''] = '''calculate_total_inventory_value : -> none '''
        self.__orderings['''none       '''] = 15
        self.__okExcepts['''none       '''] = ''''''
        self.__refCode['''none       '''] = []
        self.__refCode['''none       '''].append('''none ''')
        
        self.__actions.append(('''// Test setting low stock alert threshold ''',self.guard15,self.act15))
        self.__names['''// Test setting low stock alert threshold '''] = ('''// Test setting low stock alert threshold ''',self.guard15,self.act15)
        self.__actionClass['''// Test setting low stock alert threshold '''] = '''// Test setting low stock alert threshold '''
        self.__orderings['''// Test setting low stock alert threshold '''] = 16
        self.__okExcepts['''// Test setting low stock alert threshold '''] = ''''''
        
        self.__actions.append(('''none        ''',self.guard16,self.act16))
        self.__names['''none        '''] = ('''none        ''',self.guard16,self.act16)
        self.__actionClass['''none        '''] = '''set_low_stock_alert : (string, int) -> none '''
        self.__orderings['''none        '''] = 17
        self.__okExcepts['''none        '''] = ''''''
        self.__refCode['''none        '''] = []
        self.__refCode['''none        '''].append('''none ''')
        
        self.__actions.append(('''// Test recording product sale ''',self.guard17,self.act17))
        self.__names['''// Test recording product sale '''] = ('''// Test recording product sale ''',self.guard17,self.act17)
        self.__actionClass['''// Test recording product sale '''] = '''// Test recording product sale '''
        self.__orderings['''// Test recording product sale '''] = 18
        self.__okExcepts['''// Test recording product sale '''] = ''''''
        
        self.__actions.append(('''none         ''',self.guard18,self.act18))
        self.__names['''none         '''] = ('''none         ''',self.guard18,self.act18)
        self.__actionClass['''none         '''] = '''record_product_sale : (string, int) -> none '''
        self.__orderings['''none         '''] = 19
        self.__okExcepts['''none         '''] = ''''''
        self.__refCode['''none         '''] = []
        self.__refCode['''none         '''].append('''none ''')
        
        self.__actions.append(('''// Test exporting inventory data to a file ''',self.guard19,self.act19))
        self.__names['''// Test exporting inventory data to a file '''] = ('''// Test exporting inventory data to a file ''',self.guard19,self.act19)
        self.__actionClass['''// Test exporting inventory data to a file '''] = '''// Test exporting inventory data to a file '''
        self.__orderings['''// Test exporting inventory data to a file '''] = 20
        self.__okExcepts['''// Test exporting inventory data to a file '''] = ''''''
        
        self.__actions.append(('''none          ''',self.guard20,self.act20))
        self.__names['''none          '''] = ('''none          ''',self.guard20,self.act20)
        self.__actionClass['''none          '''] = '''export_inventory_data : (string) -> none '''
